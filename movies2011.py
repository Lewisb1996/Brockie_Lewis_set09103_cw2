...
def root():
    ...
    db.cursor().execute('insert into movies2011  values ("4", "The Twilight Saga: Breaking Down - Part 1", "$712,205,856")')
    ...
    db.cursor().execute('insert into movies2011  values ("8", "The Hangover Part III", "$586,764,305")')
